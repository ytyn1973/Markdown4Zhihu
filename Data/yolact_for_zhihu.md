...
<img src="https://www.zhihu.com/equation?tex=M_i(x, y) = \sum_{k} c_{ik} \cdot P_k(x, y)" alt="M_i(x, y) = \sum_{k} c_{ik} \cdot P_k(x, y)" class="ee_img tr_noresize" eeimg="1">
将基mask和mask 系数线性组合，其中 <img src="https://www.zhihu.com/equation?tex=cik" alt="cik" class="ee_img tr_noresize" eeimg="1"> 表示第i个检测框的第k个prototype的权重。 <img src="https://www.zhihu.com/equation?tex=Pk（x，y）" alt="Pk（x，y）" class="ee_img tr_noresize" eeimg="1"> 表示第k个prototype在 <img src="https://www.zhihu.com/equation?tex=（x，y）" alt="（x，y）" class="ee_img tr_noresize" eeimg="1"> 处的值。
